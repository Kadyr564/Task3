...
public class JTableUtils {
     ...
     * @return
     */
    public static String[] readIntArrayFromJTable(JTable table) throws ParseException {
        try {
            return lib.ArrayUtils.toPrimitive(readArrayFromJTable(table, Integer.class, Integer::parseInt, false, 0));
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
