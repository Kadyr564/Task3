...
import static com.company.List.arr;

public class ArrayUtils {
    private static final Random RND = new Random();
    
    
    public static String[] toPrimitive(Integer[] arr) {
        if (arr == null) {
            return null;
        }
    ...
    public static String[] toIntArray(String str) {
    ...
    */
    ...
    public static String[] readIntArrayFromConsole(String arrName) {
    ...
    public static String[] readIntArrayFromConsole() {
    ...
    */
     ...
     */
    public static String[][] toIntArray2(String[] lines) {
     ...
     */
    public static String[][] readIntArray2FromConsole(String arrName, boolean checkMatrix) {
        while (true) {
            try {
                if (arrName == null || arrName.length() == 0) {
                    arrName = "";
                ...
                String[][] arr2 = toIntArray2(readLinesFromConsole());
                if (checkMatrix) {
     ...
     * это считается ошибкой и предлагается повторить ввод
     */
    public static String[][] readIntArray2FromConsole(boolean checkMatrix) {
     ...
     * это считается ошибкой и предлагается повторить ввод
     */
    public static String[][] readIntArray2FromConsole() {
     ...
     */
    public static String[] readIntArrayFromFile(String fileName) {
        try {
     ...
     */
    public static String[][] readIntArray2FromFile(String fileName) {
        try {
    ...
    public static void writeArrayToFile(String fileName, String[] strings)
            throws FileNotFoundException {
